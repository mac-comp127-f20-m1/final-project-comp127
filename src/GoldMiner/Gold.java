...
public class Gold {
    ...
    public void createMap(){
        //informationOfMinerals.put(new WeightandScore(MAXDIAMOND-randomDouble(), SCOREDIAMOND, 20), diamond);
        informationOfMinerals.put( bigGold,new WeightandScore(MAXGOLD-randomDouble(), SCOREGOLD, 50));
        informationOfMinerals.put( bigGold,new WeightandScore(MAXGOLD-randomDouble()*4, SCOREGOLD-randomDouble(), 30));
        informationOfMinerals.put( smallGold,new WeightandScore(MAXGOLD-randomDouble()*8, SCOREGOLD-randomDouble()*4, 20));
        informationOfMinerals.put(bigStone,new WeightandScore(MAXSTONE-randomDouble(), SCORESTONE, 50));
        informationOfMinerals.put( smallStone,new WeightandScore(MAXSTONE-randomDouble()*4, SCOREGOLD-randomDouble(), 25));
    }
